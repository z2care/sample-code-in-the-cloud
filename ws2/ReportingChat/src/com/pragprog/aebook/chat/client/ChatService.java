...
public interface ChatService extends RemoteService {
	...
	void generateReport(String address);

    void postMessage(ChatMessage messages);//(1)
  
    ChatMessageList getMessages(String room);//(2)
  
    ChatMessageList getMessagesSince(String chat, long timestamp);//(3)
